...
export default function Project({
  ...
  return (
    ...
    >
      <section className="bg-gray-100 max-w-[60rem] px-4 py-4 border border-black/5 rounded-lg overflow-hidden sm:pr-8 relative sm:min-h-[20rem] hover:bg-gray-200 transition sm:flex dark:bg-white/10 dark:hover:bg-white/20">
        <div className="pt-4 pb-7 px-5 sm:pl-10 sm:pr-2 sm:pt-10 sm:max-w-[50%] flex flex-col h-full sm:group-even:ml-[18rem]">
          ...
          <div className="flex justify-center gap-4">
            <a
              href={liveUrl}
              className="border border-black/10 px-8 py-2 rounded-xl dark:border-white/20"
            >
              Live
            </a>
            <a
